      ...
      <div className="m-5">
        <div className="flex lg:flex-row flex-col text-justify w-full md:w-10/12 mx-auto my-5 justify-between">
          <div className="mainCont lg:w-[70%] w-full py-3">
            ...
            >
              "Food courts are heaven on earth for food enthusiasts. They
              present a cultural mix of tastes, cuisines, and flavours in one
              venue. Whether gourmet burgers, genuine sushi, hot street food, or
              rich desserts appeal to your mood, food courts have something for
              every desire. From contemporary malls to vibrant marketplaces, let
              us delve deeper into what food courts have become and where to
              find the best under one roof. "
            </p>
          </div>
        ...
        <div className="w-full md:w-10/12 mx-auto text-justify">
          <div className="flex gap-10 lg:flex-row flex-col items-center">
            <div className="">
              ...
              <p className="text-black text-[18px] indent-[2rem]">
                ...
                tucked in the corner of a shopping mall. Now, they are lively
                food centres that combine local specialities, international
                cuisine, and even Michelin-starred restaurants. Having a choice
                of multiple dining options in one venue makes them an attractive
                destination for families, friends, and single diners. To boot,
                the relaxed setting is more cost-effective than an upscale
                restaurant.
              </p>
              <p className="text-black text-[18px] indent-[2rem]">
          ...
          <p className="text-black text-[18px] indent-[2rem]">
            ...
            themselves, with a variety of international foods available. These
            are some must-haves:
          </p>
          <ul
          ...
          >
            ...
            >
              <div className="flex flex-col flex-1 gap-4">
                ...
                <p className=" text-black">
                  For fans of strong flavours, food courts usually have stalls
                  for sushi, dim sum, ramen, or spicy Thai curries.
                </p>
              </div>
            </li>
            <li
            ...
            >
              <div className="flex flex-col flex-1 gap-4">
                ...
                <p className=" text-black">
                  Juicy cheeseburgers, crispy fried chicken, and loaded fries
                  are always a winner.
                </p>
              </div>
            </li>
            ...
            >
              <div className="flex flex-col flex-1 gap-4">
                ...
                <p className=" text-black">
                  Gyros, falafel wraps, grilled kebabs, and fresh hummus
                  transport the taste of Greece, Turkey, and the Middle East to
                  food courts.
                </p>
              </div>
            </li>
          ...
          <p className="text-black text-[18px]">
            If you’re a foodie traveller, visiting some of the world’s most
            famous food courts should be on your bucket list. <br /> Here are
            some top contenders:
          </p>
          <div className="flex gap-10 lg:flex-row flex-col items-center">
            <div className="py-4">
          ...
          <ul>
            <li className="text-black text-[18px]">
              <b>Walk Around First:</b> Walk around to check out all the choices
              before deciding on one dish. This way, you won't get food envy
              after seeing something even better.
            </li>
            <li className="text-black text-[18px]">
              <b>Eat with Friends: </b>If you can, go with friends so that you
              can order several dishes and share them, enabling you to taste a
              greater number of foods.
            </li>
            <li className="text-black text-[18px]">
              <b>Time It Right : </b>Food courts can get crowded, especially
              during peak hours. Visiting during off-hours can ensure shorter
              lines and a more relaxed dining experience.
            </li>
            <li className="text-black text-[18px]">
              <b>Check for Local Specials:</b> Many food courts feature rotating
              vendors or limited-time offerings that showcase seasonal
              ingredients or special promotions.
            </li>
            <li className="text-black text-[18px]">
              <b>Try Something New:</b> Step out of your comfort zone and taste
              something you've never had before—you might just discover a new
              favourite!
            </li>
          </ul>
          ...
          <div className="py-10">
            ...
            <p className="text-black text-[18px] indent-[2rem]">
              ...
              playgrounds where one gets a taste of everything in moderation.
              You might be out to experiment with international cuisine,
              yearning for comfort food, or just looking for a fast, delectable
              meal, but a good food court has all this and more. Next time you
              feel hungry and cannot make up your mind, take the next turn into
              a food court and let your palate set sail on a gastronomic tour!
            </p>
          </div>
        </div>
      </div>
